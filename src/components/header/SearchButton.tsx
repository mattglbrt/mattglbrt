...
function SearchPanel() {
  ...
  if (import.meta.env.DEV) {
      ...
      <div className="h-full flex items-center justify-center">
        <div className="flex gap-2">
          ...
          <div>
            ...
            <div className="text-sm">This function is based on pagefind, please try again after building.</div>
          </div>
        </div>
      </div>
    )
    ...
    resultList = (
      <>
        <div className="text-sm px-3 mb-2">Find the following {results.length} results</div>
        {results.map((item) => {
          return (
            <a
              href={item.url}
